...
const example = [
  new Monkey([79, 98],function (i) { this.items[i] *= 19},23,[3,2]),
  new Monkey([54, 65, 75, 74],function(i) {this.items[i] += 6},19,[0,2]),
  new Monkey([79, 60, 97], function (i) {this.items[i] *=this.items[i] },13,[3,1]),
  new Monkey([74],function(i) {this.items[i] += 3},17,[1,0])
];
